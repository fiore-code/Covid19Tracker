...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<footer class=\" footer\">\n  <div class=\" container-fluid\">\n    <ul class=\" nav\">\n      <li class=\" nav-item\">\n        <a class=\" nav-link\" href=\"https://acroalias.in\" target=\"_blank\">\n          Acroalias Technologies Pvt Ltd © 2018\n        </a>\n      </li>\n      <li class=\" nav-item\">\n        <a class=\" nav-link\" href=\"https://acroalias.in\" target=\"_blank\">\n          About Us\n        </a>\n      </li>\n      <li class=\" nav-item\">\n        <a class=\" nav-link\" href=\"https://acroalias.in\" target=\"_blank\"> Contact Us </a>\n      </li>\n    </ul>\n    <div class=\" copyright\">\n      * This information is sourced from crowdsource data.<br> Do not panic & wait for government sources to verify\n    </div>\n  </div>\n</footer>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<nav class=\" navbar navbar-expand-lg navbar-absolute navbar-transparent\">\n  <div class=\" container-fluid\">\n    <div class=\" navbar-wrapper\">\n      <div class=\" navbar-toggle d-inline\">\n        <button class=\" navbar-toggler\" type=\"button\" (click)=\"sidebarToggle()\">\n          <span class=\" navbar-toggler-bar bar1\"> </span>\n          <span class=\" navbar-toggler-bar bar2\"> </span>\n          <span class=\" navbar-toggler-bar bar3\"> </span>\n        </button>\n      </div>\n      <a class=\" navbar-brand\" href=\"javascript:void(0)\">{{ getTitle() }} </a>\n    </div>\n    <button\n      aria-label=\"Toggle navigation\"\n      class=\" navbar-toggler\"\n      (click)=\"collapse()\"\n      [attr.aria-expanded]=\"!isCollapsed\"\n      aria-controls=\"collapseExample\"\n      id=\"navigation\"\n      type=\"button\"\n    >\n      <span class=\" navbar-toggler-bar navbar-kebab\"> </span>\n      <span class=\" navbar-toggler-bar navbar-kebab\"> </span>\n      <span class=\" navbar-toggler-bar navbar-kebab\"> </span>\n    </button>\n    <div class=\" navbar-collapse\" [ngbCollapse]=\"isCollapsed\" id=\"navigation\">\n      <ul class=\" navbar-nav ml-auto\"> \n        <li class=\"nav-item\" style=\"padding-right: 360px;font-size: 30px;\">\n          <a class=\"nav-link\" href=\"#\" target=\"_blank\"><b>COVID-19</b> Tracker</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" href=\"https://acroalias.in/\" target=\"_blank\">About Us</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" href=\" https://icmr.nic.in/node/39071\" target=\"_blank\">ICMR</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" href=\"https://www.who.int/emergencies/diseases/novel-coronavirus-2019\" target=\"_blank\">World Health Organization</a>\n        </li>\n        <li class=\"nav-item\">\n          <a class=\"nav-link\" href=\"https://www.cdc.gov/coronavirus/2019-ncov/index.html\" target=\"_blank\">CDC</a>\n        </li>\n      </ul>\n    </div>\n  </div>\n</nav>\n\n<ng-template #content let-modal>\n  <div class=\" modal-header\">\n    <input\n      class=\" form-control\"\n      id=\"inlineFormInputGroup\"\n      placeholder=\"SEARCH\"\n      type=\"text\"\n    />\n\n    <button\n      aria-label=\"Close\"\n      class=\" close\"\n      data-dismiss=\"modal\"\n      type=\"button\"\n      (click)=\"modal.dismiss('Cross click')\"\n    >\n      <i class=\" tim-icons icon-simple-remove\"> </i>\n    </button>\n  </div>\n\n</ng-template>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"logo\">\n  <a href=\"#nothing\" class=\"simple-text logo-mini\">\n    <div class=\"logo-img\">\n      <img src=\"./assets/img/acro_v1.png\" />\n    </div>\n  </a>\n  <a href=\"http://www.acroalias.com\" class=\"simple-text logo-normal\" style=\"font-size: 18px;\" target=\"_blank\">\n    Acroalias\n  </a>\n</div>\n<div class=\"sidebar-wrapper\">\n  <ul class=\"nav\">\n    <li\n      routerLinkActive=\"active\"\n      *ngFor=\"let menuItem of menuItems\"\n      class=\"{{ menuItem.class }} nav-item\"\n    >\n      <a [routerLink]=\"[menuItem.path]\">\n        <i class=\"tim-icons  {{ menuItem.icon }}\"></i>\n        <p>{{ menuItem.title }}</p>\n      </a>\n    </li>\n  </ul>\n</div>\n");
...
/* harmony import */ var _app_services_coronaData_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../app/services/coronaData.service */ "./src/app/services/coronaData.service.ts");
/* harmony import */ var _app_services_app_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../app/services/app.service */ "./src/app/services/app.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_9__["AppComponent"], _layouts_admin_layout_admin_layout_component__WEBPACK_IMPORTED_MODULE_10__["AdminLayoutComponent"], _layouts_auth_layout_auth_layout_component__WEBPACK_IMPORTED_MODULE_11__["AuthLayoutComponent"]],
            providers: [_app_services_coronaData_service__WEBPACK_IMPORTED_MODULE_7__["CoronaDataService"], _app_services_app_service__WEBPACK_IMPORTED_MODULE_8__["AppService"]],
...
var AppService = /** @class */ (function () {
    ...
    AppService.prototype.downloadFile = function (data, filename) {
        if (filename === void 0) { filename = 'data'; }
        var csvData = this.ConvertToCSV(data, [0, 2, 3, 4, 5, 6, 7, 8]);
        console.log(csvData);
    ...
    AppService.prototype.ConvertToCSV = function (objArray, headerList) {
        var array = typeof objArray != 'object' ? JSON.parse(objArray) : objArray;
        var str = '';
        var row = 'S.No,';
        var count = 0;
        var headerlistShown = ['Age', 'State', 'District', 'City', 'Gender', 'Nationality', 'Travel History', 'Date'];
        for (var index in headerlistShown) {
            row += headerlistShown[index] + ',';
        }
        row = row.slice(0, -1);
        str += row + '\r\n';
...
/***/ "./src/app/services/coronaData.service.ts":
/*!************************************************!*\
  !*** ./src/app/services/coronaData.service.ts ***!
  \************************************************/
/*! exports provided: CoronaDataService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CoronaDataService", function() { return CoronaDataService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm5/core.js");
...
var CoronaDataService = /** @class */ (function () {
    function CoronaDataService(http) {
        this.http = http;
    }
    CoronaDataService.prototype.getCoronaData = function () {
    ...
    // }
    CoronaDataService.prototype.getAgeCategoryCount = function () {
        return this.http.get('https://thecampfire.in/api/age_count_data');
    };
    CoronaDataService.prototype.getStateWiseData = function () {
        return this.http.get('https://thecampfire.in/api/daily_state_count');
    };
    CoronaDataService.prototype.getWeeklyData = function () {
        return this.http.get('https://thecampfire.in/api/weekly_count');
    };
    CoronaDataService.prototype.getDistrictData = function () {
        return this.http.get('https://thecampfire.in/api/state_data');
    };
    CoronaDataService.prototype.getTrackingData = function () {
        return this.http.get('https://thecampfire.in/api/tracking_data');
    };
    CoronaDataService.prototype.getResources = function () {
        return this.http.get('https://thecampfire.in/api/covid_resources');
    };
    CoronaDataService.prototype.getDailyCount = function () {
        return this.http.get('https://thecampfire.in/api/daily_total_updates');
    };
    CoronaDataService.prototype.GetLocationCoordinates = function (lat, long) {
        this.lat = lat;
        this.lng = long;
    };
    CoronaDataService.prototype.getLocationCoordinatesMapbox = function (startLat, startLong, endLat, endLong) {
        this.startLat = startLat;
        this.startLong = startLong;
        this.endLat = endLat;
        this.endLong = endLong;
    };
    CoronaDataService.prototype.getRouteMapbox = function () {
    ...
    CoronaDataService.prototype.getNearestLocation = function () {
        return this.http.get('https://thecampfire.in/api/getLocation/' + this.lat + '/' + this.lng);
    };
    CoronaDataService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
    CoronaDataService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])
    ], CoronaDataService);
    return CoronaDataService;
}());
...
var environment = {
    production: false,
    mapbox: {
        accessToken: 'pk.eyJ1Ijoic3ViaGFtLWZpb3JlIiwiYSI6ImNrOHl2Y3NkNDBsbm4zbHRhaGR6bndtNHgifQ.ljcjEqww1G0IHITR4MesbQ'
    },
    mapbox2: {
        accessToken: 'pk.eyJ1IjoiYml0YW5iMTIzIiwiYSI6ImNrOHlwdWlieTFrbW4zZ3FzN2Qwc3MzdmYifQ.qR6zhcdrOSS_k1h0yWzWJQ'
    }
};
/*
...
module.exports = __webpack_require__(/*! C:\Users\supar\Desktop\Covid19\Testing\Newblackdashboard\covid19tracker\src\main.ts */"./src/main.ts");
